...
BikerCocaine = {
    ...
    Details = {
        ...
        Set = function(details, refresh)
        BikerCocaine.Details.Clear(false)
         if (details ~= "") then
                SetIplPropState(BikerCocaine.interiorId, details, true, refresh)
                else
                if (refresh) then RefreshInterior(BikerCocaine.interiorId) end
            end
        end,
        Clear = function(refresh)
            SetIplPropState(BikerCocaine.interiorId, {none}, false, refresh)
        end
    },
    ...
    LoadDefault = function()
        ...
        BikerCocaine.Details.Set(BikerCocaine.Details.cokeBasic1)
        BikerCocaine.Details.Set(BikerCocaine.Details.cokeBasic2)
        BikerCocaine.Details.Set(BikerCocaine.Details.cokeBasic3)
        BikerCocaine.Details.Set(BikerCocaine.Details.cokeUpgrade1)
        BikerCocaine.Details.Set(BikerCocaine.Details.cokeUpgrade2)
